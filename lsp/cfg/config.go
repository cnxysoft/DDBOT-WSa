...
// GetWeiboAPIModeBaseURL 获取微博 API 模式的基础 URL
func GetWeiboAPIModeBaseURL() string {
	return strings.TrimSpace(config.GlobalConfig.GetString("weibo.apiModeBaseURL"))
}
